...
Source for the 20 animated clips embedded in [`../Readme-v2.md`](../Readme-v2.md).
...
- `npm run encode [scene…]` — ffmpeg: 1920×1080 30 fps H.264 MP4, plus a
  ...
  would exceed 8 MB).
- `python scripts/build-readme.py` — regenerates `../Readme-v2.md` from
  `../Readme.md`, swapping every figure/equation image for its clip.
