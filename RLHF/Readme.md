...
![The agent / environment loop](videos/01-rl-loop.gif)

<sub>▶ [mp4](videos/01-rl-loop.mp4)</sub>
...
![The cat, the broom, the bathtub and the meat](videos/02-cat-grid.gif)

<sub>▶ [mp4](videos/02-cat-grid.mp4)</sub>
...
![Agent and environment, then the same loop as a language model](videos/03-rl-to-lm.gif)

<sub>▶ [mp4](videos/03-rl-to-lm.mp4)</sub>
...
![History: TAMER, deep RL from human preferences, consensus data collection, and the RLHF survey abstract](videos/04-history.gif)

<sub>▶ [mp4](videos/04-history.mp4)</sub>
...
![InstructGPT: the three steps](videos/05-instructgpt-3-steps.gif)

<sub>▶ [mp4](videos/05-instructgpt-3-steps.mp4)</sub>
...
![The three phases of RLHF](videos/06-hf-pipeline-overview.gif)

<sub>▶ [mp4](videos/06-hf-pipeline-overview.mp4)</sub>
...
![Phase 1: language model pretraining](videos/07-hf-pretraining.gif)

<sub>▶ [mp4](videos/07-hf-pretraining.mp4)</sub>
...
```math
\mathrm{loss}(\theta) = -\frac{1}{\binom{K}{2}}\, \mathbb{E}_{(x, y_w, y_l) \sim D}\Big[ \log\Big( \sigma\big( r_\theta(x, y_w) - r_\theta(x, y_l) \big) \Big) \Big]
```
...
![The reward-model loss](videos/09-rm-loss.gif)

<sub>▶ [mp4](videos/09-rm-loss.mp4)</sub>

#### 2. Reward Model Training:

![Phase 2: reward model training](videos/08-hf-reward-model.gif)

<sub>▶ [mp4](videos/08-hf-reward-model.mp4)</sub>
...
<sub>▶ [mp4](videos/10-ppo-ptx-objective.mp4)</sub>

where $\pi^{\mathrm{RL}}_\phi$
...
![Phase 3: fine-tuning with RL](videos/11-hf-rl-finetune.gif)

<sub>▶ [mp4](videos/11-hf-rl-finetune.mp4)</sub>
...
![Recap: Stiennon et al. (TL;DR) and the Anthropic workflow](videos/12-recap.gif)

<sub>▶ [mp4](videos/12-recap.mp4)</sub>
...
![Scheme of deep RL and the trajectory equations](videos/13-trajectories.gif)
...
<sub>▶ [mp4](videos/14-ppo-loss.mp4)</sub>
...
![Algorithm 1: PPO, Actor-Critic style](videos/15-ppo-algorithm.gif)

<sub>▶ [mp4](videos/15-ppo-algorithm.mp4)</sub>

### RLHF-Direct Preference Optimization algorithm:

![RLHF versus DPO](videos/16-dpo-vs-rlhf.gif)

<sub>▶ [mp4](videos/16-dpo-vs-rlhf.mp4)</sub>
...
<sub>▶ [mp4](videos/17-dpo-derivation.mp4)</sub>
...
![Theoretical analysis of DPO](videos/18-dpo-theory.gif)

<sub>▶ [mp4](videos/18-dpo-theory.mp4)</sub>
...
![Preliminaries: SFT, reward modelling, RL fine-tuning](videos/19-preliminaries.gif)

<sub>▶ [mp4](videos/19-preliminaries.mp4)</sub>
...
![PPO vs DPO: reward/KL frontier and TL;DR win rate](videos/20-ppo-vs-dpo-charts.gif)

<sub>▶ [mp4](videos/20-ppo-vs-dpo-charts.mp4)</sub>
