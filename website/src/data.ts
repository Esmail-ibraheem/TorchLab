const packages = [
  {
    id: 0,
    name: 'Transformer',
    url: 'https://github.com/Esmail-ibraheem/TorchLab/tree/main/04-papers-in-pytorch/transformer',
  ...
  },
  {
    id: 1,
    name: 'X-Llama',
    url: 'https://github.com/Esmail-ibraheem/TorchLab/tree/main/04-papers-in-pytorch/llama',
  ...
  },
  {
    id: 2,
    name: 'Dali package',
    url: 'https://github.com/Esmail-ibraheem/TorchLab/tree/main/04-papers-in-pytorch/diffusion',
  ...
  },
  {
    id: 3,
    name: 'InstructGPT ',
    url: 'https://github.com/Esmail-ibraheem/TorchLab/tree/main/04-papers-in-pytorch/rlhf',
