"""Build ../README.md (animated) from ../README-original.md: same prose, every figure/equation image replaced by its clip.
...
src = open(os.path.join(rlhf, 'README-original.md'), encoding='utf-8').read().split('\n')
out = []
...
text = '\n'.join(out)
open(os.path.join(rlhf, 'README.md'), 'w', encoding='utf-8').write(text)
