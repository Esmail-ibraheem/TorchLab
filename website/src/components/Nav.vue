    ...
    <nav class="common-padding flex flex-row justify-between items-center z-50">
      <p class="text-xl font-logo group flex-center w-14">
        <router-link
          ...
          >TorchLab</router-link
        >
      </p>

      <ul class="flex gap-5">
        <li class="nav-link">
          <RouterLink to="/TorchLab/"> Home </RouterLink>
        </li>
        <li class="nav-link">
          <RouterLink to="/TorchLab/packages"> Packages </RouterLink>
        </li>
        ...
        <!-- Linkedin -->
        <li class="nav-link">
          <a href="https://www.linkedin.com/in/esmail-a-gumaan/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="20"
        ...
        <!-- email -->
        <li class="nav-link">
          <a href="mailto:esm.agumaan@gmail.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="20"
